# 0 "counter_la_fir.c"
# 1 "/home/ubuntu/soc/Lab4/lab-caravel_fir/testbench/counter_la_fir//"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "counter_la_fir.c"
# 19 "counter_la_fir.c"
...
# 139 "counter_la_fir.c"
 ...
 for (i=1; i<=3; i=i+1){
  ...
  (*(volatile uint32_t*)0x2600000c) = *(tmp+11) << 16;
  (*(volatile uint32_t*)0x2600000c) = *(tmp+12) << 16;
  (*(volatile uint32_t*)0x2600000c) = *(tmp+13) << 16;
  (*(volatile uint32_t*)0x2600000c) = *(tmp+14) << 16;


  (*(volatile uint32_t*)0x2600000c) = (*(tmp+14) << 24) + 0x5A0000;
 }
