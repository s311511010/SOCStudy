...
.Ltext0:
	...
	.file 0 "/home/ubuntu/soc/final/testbench/counter_la" "counter_la.c"
	.align	2
	.globl	putchar
...
.L22:
	.loc 2 107 43 discriminator 1
	.loc 2 107 10 is_stmt 0 discriminator 1
	lw	a5,0(s0)
	.loc 2 107 43 discriminator 1
	beq	a5,a4,.L22
	.loc 2 111 2 is_stmt 1
	.loc 2 111 114 is_stmt 0
	li	a5,-268423168
	sw	zero,12(a5)
	.loc 2 111 57
	sw	zero,28(a5)
	...
	.loc 2 144 14 is_stmt 0
	call	matmul
.LVL5:
	.loc 2 145 2 is_stmt 1
	.loc 2 145 44 is_stmt 0
	lw	a2,0(a0)
	.loc 2 146 48
	lw	a3,4(a0)
	.loc 2 147 48
	...
	.loc 2 147 48 is_stmt 0
	slli	a4,a4,16
	.loc 2 147 36
	sw	a4,12(s0)
	.loc 2 148 2 is_stmt 1
	.loc 2 148 48 is_stmt 0
	slli	a5,a5,16
	.loc 2 148 36
	sw	a5,12(s0)
