...
/*
	...
	int *tmp0 = fir();
	reg_mprj_datal = *tmp0 << 16;
	reg_mprj_datal = *(tmp0+1) << 16;
	reg_mprj_datal = *(tmp0+2) << 16;
	reg_mprj_datal = *(tmp0+3) << 16;
	reg_mprj_datal = *(tmp0+4) << 16;
	reg_mprj_datal = *(tmp0+5) << 16;
	reg_mprj_datal = *(tmp0+6) << 16;
	reg_mprj_datal = *(tmp0+7) << 16;
	reg_mprj_datal = *(tmp0+8) << 16;
	reg_mprj_datal = *(tmp0+9) << 16;
	reg_mprj_datal = *(tmp0+10) << 16;
