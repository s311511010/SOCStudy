# 0 "counter_la.c"
# 1 "/home/ubuntu/soc/final/testbench/counter_la//"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "counter_la.c"
# 19 "counter_la.c"
...
# 143 "counter_la.c"
 (*(volatile uint32_t*)0x2600000c) = 0xAB520000;
 int *tmp1 = matmul();
 (*(volatile uint32_t*)0x2600000c) = *tmp1 << 16;
 (*(volatile uint32_t*)0x2600000c) = *(tmp1+1) << 16;
 (*(volatile uint32_t*)0x2600000c) = *(tmp1+2) << 16;
 (*(volatile uint32_t*)0x2600000c) = *(tmp1+3) << 16;
 (*(volatile uint32_t*)0x2600000c) = 0xAB530000;
# 166 "counter_la.c"
}
